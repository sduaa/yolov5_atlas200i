...
public:
    ...
    */
    ...
    static std::vector<BBox> PostProcess(const string &path, aclmdlDataset *modelOutput, shared_ptr<ImageDesc>& imageData);
    ...
    static void BufferDeleter(void *p);

    static void DrawBoxToResult(const vector<BBox> &result, cv::Mat& imageInput);
};
